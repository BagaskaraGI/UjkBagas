package com.example.ujkbagas.dummyData

import com.example.ujkbagas.model.Menu

val dataMenuImage = arrayListOf<String>(
    //Data Makanan
    ...
    "https://pinhome-blog-assets-public.s3.amazonaws.com/2022/02/image-100.png",
    //Data Dessert
...
val dataMenuNama = arrayListOf<String>(
    "Sushi",
    "Ramen",
    "chawan musi",
    "Okonomiyaki",
...
val dataMenuDeskripsi = arrayListOf<String>(
    ...
    "Aojiru merupakan minuman sayur Jepang, dan menjadi salah satu minuman paling populer di Jepang",
...
val dataMenuHarga = arrayListOf<String>(
    "30000",
    "60000",
    "18000",
    "35000",
...
val dataMenuKategori = arrayListOf<String>(
    "Makanan",
    "Makanan",
    "Makanan",
    "Makanan",
...
val dataMenu: List<Menu> = dataMenuNama.indices.map {
    Menu(
        id = it,
        namaMenu = dataMenuNama[it],
        hargaMenu = dataMenuHarga[it].toInt(),
        deskripsiMenu = dataMenuDeskripsi[it],
        gambarMenu = dataMenuImage[it],
        kategoriMenu =  dataMenuKategori[it]
    )
}
